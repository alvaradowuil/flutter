    ...
    return Container(
      child: Center(
          child: FutureBuilder<GetOrdersResponse>(
            future: OrderProvider().getOrderPending(
              GetOrdersRequest('pendientes')), //sets the getQuote method as the expected Future
                    ...
                    itemBuilder: (BuildContext context, int index){
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context, 
                            MaterialPageRoute(builder: (context) => OrderPage(order: snapshot.data.orders[index],mostrarBotonEntregar: true,)));
